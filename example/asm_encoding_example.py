...
def main():
    ...
    print(f"   Input:  {asm1}")
    print(
        f"   Parsed: {instance1.instruction.mnemonic} with operands {instance1.operand_values}"
    )
    ...
    instance4 = InstructionInstance(
        instruction=jalr_instr, operand_values={"rd": 0, "rs1": 2, "imm": 0}
    )
    print("   Created: jalr(rd=0, rs1=2, imm=0)")
